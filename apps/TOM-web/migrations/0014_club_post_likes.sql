...
CREATE UNIQUE INDEX IF NOT EXISTS idx_club_post_likes_post_user ON club_post_likes(post_id, user_id);
CREATE INDEX IF NOT EXISTS idx_club_post_likes_post_id ON club_post_likes(post_id);
CREATE INDEX IF NOT EXISTS idx_club_post_likes_user_id ON club_post_likes(user_id);
