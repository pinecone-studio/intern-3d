...
const clubStatusLabels: Record<ClubStatus, string> = {
  draft: 'Ноорог',
...
export default function DetailPage() {
  ...
  const [message, setMessage] = useState('Клубийн дэлгэрэнгүй мэдээллийг ачааллаа.');
              ...
              clubs.map((club) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <StatusBadge
                      type={club.status}
                      text={clubStatusLabels[club.status]}
                    />
                  </div>
                </button>
              ))
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <StatusBadge
                      type={draft.status}
                      text={clubStatusLabels[draft.status]}
                    />
                    {draft.verified ? (
