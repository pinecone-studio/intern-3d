...
export default function TeacherDashboard() {
  ...
  const [message, setMessage] = useState('Багшийн самбарын шууд өгөгдөлд холбогдлоо.');
  ...
  const statusLabel = (status: Club['status']) =>
    ({
      active: 'Идэвхтэй',
      paused: 'Түр зогссон',
                ...
                >
                  <div>
                    ...
                    <p className="mt-1 text-xs text-[color:var(--muted-foreground)]">
                      {request.createdBy} · {request.startDate || 'Огноо байхгүй'}{' '}
