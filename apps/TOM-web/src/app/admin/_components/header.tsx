...
const navItems = [
  ...
  { href: '/admin/requests', label: 'Хүсэлтүүд', icon: CalendarDays },
  { href: '/admin/events', label: 'Арга хэмжээ', icon: CalendarDays },
  { href: '/admin/clubs', label: 'Клубүүд', icon: Users },
  { href: '/admin/teacher', label: 'Багшийн самбар', icon: CalendarDays },
] as const;
