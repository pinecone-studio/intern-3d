...
export default function AdminDashboard() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="dashboard-entrance mt-6 rounded-[30px] border border-[#dce7f8] bg-white p-4 shadow-[0_18px_60px_rgba(19,45,96,0.08)]">
        <div className="flex flex-wrap gap-2">
          {[
            {
              key: 'requests',
              label: 'Клубийн хүсэлт',
              count: pendingRequests.length,
            },
            { key: 'users', label: 'Хэрэглэгч', count: users.length },
            { key: 'clubs', label: 'Active клуб', count: activeClubs.length },
            { key: 'spam', label: 'Spam', count: spamQueue.length },
          ].map((item) => {
            ...
            return (
              <button
                ...
                className={`rounded-full px-4 py-2 text-sm font-semibold transition ${
                  isActive
                    ? 'bg-[#173765] text-white shadow-soft'
        ...
        <p className="mt-3 text-sm text-[#57708f]">
          Том feature-үүдийг тус тусад нь харуулж байгаа тул нэг дэлгэц дээр
          хэт урт болохгүй, хэрэглэгч зөвхөн хэрэгтэй хэсгээ нээж ажиллана.
        </p>
      </section>
              ...
              <div className="mb-5 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm text-[#57708f]">
                    Багш эсвэл алба шинэ клуб хүсэх үед энэ хэсгийг бөглөнө.
                    Хүсэлт pending төлөвөөр эхэлж, доорх дарааллаас батлах
                    эсвэл татгалзах боломжтой.
                  </p>
                </div>
            ...
            <aside className="space-y-4">
              <section className="dashboard-entrance rounded-[30px] border border-[#dce7f8] bg-white p-5 shadow-[0_18px_60px_rgba(19,45,96,0.08)]">
                ...
                <div className="mt-4 space-y-3 text-sm text-[#57708f]">
                  ...
                  <div className="rounded-2xl bg-[#f6f9ff] p-4">
                    Админ зөвшөөрсөн үед клубийг pending-ээс active руу
                    шилжүүлэх.
                  </div>
                  <div className="rounded-2xl bg-[#f6f9ff] p-4">
                    Сонирхол {thresholdGoal} сурагчийн босгонд хүрсэн эсэхийг
                    шалгах.
                  </div>
                  <div className="rounded-2xl bg-[#f6f9ff] p-4">
                    Хуурамч, spam, эсвэл сэжигтэй клубийг тархахаас нь өмнө
                    устгах.
                  </div>
                </div>
              </section>
              ...
              <section className="dashboard-entrance rounded-[30px] border border-[#dce7f8] bg-white p-5 shadow-[0_18px_60px_rgba(19,45,96,0.08)]">
                ...
                <p className="mt-2 text-sm text-[#57708f]">
                  Клубууд хамгийн бага сонирхлын босгонд хүрвэл нээлт хийхэд
                  бэлэн гэж тэмдэглэж болно.
                </p>
          ...
          <section className="dashboard-entrance mt-6 rounded-[30px] border border-[#dce7f8] bg-white p-5 shadow-[0_18px_60px_rgba(19,45,96,0.08)]">
            <div className="mb-5 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-[#57708f]">
                  Хүсэлт бүрийг батлах эсвэл татгалзаж, зөвшөөрөгдсөн
                  клубүүдийг идэвхтэй жагсаалтад оруулна.
                </p>
              </div>
              <StatusBadge
                type="pending"
                text={`${pendingRequests.length} хүлээгдэж байна`}
              />
            </div>
        ...
        <section className="dashboard-entrance mt-6 rounded-[30px] border border-[#dce7f8] bg-white p-5 shadow-[0_18px_60px_rgba(19,45,96,0.08)]">
          <div className="mb-5 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-[#57708f]">
                Хэрэглэгч нэмэх, role өөрчлөх, restriction тавих, эсвэл ban
                хийх үйлдлүүдийг нэг дороос удирдана.
              </p>
            </div>
            <StatusBadge
              type="review"
