...
export function RoomDetailContent({ roomId }: { roomId: string }) {
  ...
  if (loading || !clock) return <div className="flex min-h-[420px] items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" /></div>
