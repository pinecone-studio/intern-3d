...
export function SchedulerCalendarSidebar({ calendarMonth, focusedDate, isCalendarOpen, monthDays, onSelectDay, onToday, setCalendarMonth, viewMode, weekStart }: SchedulerCalendarSidebarProps) {
  ...
  return (
    <aside className={cn(isCalendarOpen ? 'block' : 'hidden', 'h-full rounded-2xl border border-[#e5e7f3] bg-[#fbfbfe] p-3 shadow-sm dark:border-[#2c3149] dark:bg-[#171b27] xl:sticky xl:top-4 xl:block')}>
